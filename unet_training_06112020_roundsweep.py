...
train_path ='/media/hd1/unet_model_training_data/unet-master/data_'+channel+'/unet_data/round_'+rnd+'_train_little-delta_'+little_delta+'_total-time_'+total_time
...
model_checkpoint = ModelCheckpoint('/media/hd1/unet_model_training_data/unet-master/data_'+channel+'/round_'+rnd+'_06112020_unet_little-delta_'+little_delta+'_total-time_'+total_time+'.hdf5', monitor='loss',verbose=1, save_best_only=True)
...
try:
	...
	#Test the model
    test_path ='/media/hd1/unet_model_training_data/unet-master/data_'+channel+'/unet_data/round_'+rnd+'_test_little-delta_'+little_delta+'_total-time_'+total_time
    ...
    fil = '/media/hd1/unet_model_training_data/unet-master/data_'+channel+'/round_'+rnd+'_06112020_unet_little-delta_'+little_delta+'_total-time_'+total_time+'.hdf5'
...
if not os.path.isfile('/media/hd1/unet_model_training_data/unet-master/MasterResults_rounds.csv'):
    df.to_csv('/media/hd1/unet_model_training_data/unet-master/MasterResults_rounds.csv')
else:
    with open('/media/hd1/unet_model_training_data/unet-master/MasterResults_rounds.csv', 'a') as f:
