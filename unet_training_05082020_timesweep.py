...
model_checkpoint = ModelCheckpoint('/media/hd1/unet_model_search_05082020/unet-master/data_'+channel+'/unet_little-delta_'+little_delta+'_total-time_'+total_time+'.hdf5', monitor='loss',verbose=1, save_best_only=True)
